...
public class PointCPTestD2 {
	 ...
	 *
	 * @param args[0]
	 *            The coordinate type. P for polar and C for cartesian.
	 * @param args[1]
	 *            The value of X or RHO.
	 * @param args[2]
	...
	public static void main(String[] args) {
		...
		try {
			point = new PointCPD2(args[0].toUpperCase().charAt(0), Double.valueOf(args[1]).doubleValue(),
	...
	private static PointCPD2 getInput() throws IOException {
		...
		for (int i = 0; i < 3; i++) {
			while (!(isOK)) {
				...
				{
					System.out.print(
							"Enter the type of Coordinates you " + "are inputting Polar only please ( (P)olar ): ");
